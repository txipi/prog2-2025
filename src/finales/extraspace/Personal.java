 ...
 */
public abstract class Personal implements Serializable, PaisComprobable {
	...
	/** Calcula el coste del personal
	 * @return	Coste en millones de euros
	 */
	public abstract double getCoste();

	/** Devuelve una línea representativa del objeto de personal, con sus datos separados por tabuladores 
	 * @return	Línea con formato dependiente de la clase particular
	 */
